 ...
 */
 ...
 function standard_scripts_and_style() {
	...
	wp_enqueue_script( 'base-theme-jquery-js', get_template_directory_uri() . '/assets/js/libs/jquery.js', array(), null, true );
	...
	wp_enqueue_script( 'base-theme-main-js', get_template_directory_uri() . '/assets/js/main.min.js', array('base-theme-jquery-js'), filemtime(get_template_directory() . '/assets/js/main.min.js'), true );
}
