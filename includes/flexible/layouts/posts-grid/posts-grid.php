...
if (empty($section['disable_section'])):
    ...
    $section_classes = 'posts-grid posts-grid-index-' . $instance_index;
    if ($enable_slider) {
    ...
    if ($loop->have_posts()):
        ...
        $render_card = function ($extra_class = '') use ($post_title_style_attr, $post_content_style_attr) {
            $thumbnail_alt = '';
            ...
            <a class="<?php echo esc_attr($card_class); ?>" href="<?php echo esc_url(get_permalink()); ?>">
                ...
                <div class="post-content"<?php echo $post_content_style_attr; ?>><?php echo wp_kses_post(get_the_excerpt()); ?></div>
            </a>
            <?php
        };
?>
<section class="<?php echo esc_attr($section_classes); ?>"<?php echo $section_style_attr; ?>>
    <div class="container">
        ...
        <?php if ($enable_slider): ?>
            <div class="posts-grid__slider swiper">
