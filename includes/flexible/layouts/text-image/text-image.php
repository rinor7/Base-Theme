<?php
$section = get_sub_field('text-image-section') ?: [];
...
if (empty($section['disable_section'])):
    ...
    if (!empty($section['image_no_container_right'])) {
        $section_classes .= ' image-no-container-right';
    }
...
<section class="<?php echo esc_attr($section_classes); ?>">
    <div class="container">
        <div class="row">
            <div class="flex-text-image__media col-lg-6">
            ...
            <div class="flex-text-image__content col-lg-6">
                ...
                <?php if (!empty($button_1) || !empty($button_2)): ?>
                    <div class="flex-text-image__buttons">
